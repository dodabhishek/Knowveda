  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left"
      >
        ...
        {/* Right column */}
        <div
          className="mx-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none 
        ...
        >
          ...
          <div className="pt-5">
            <div className="flex items-center gap-2">
              <img src={assets.time_left_clock_icon} alt="time-left-clock" 
              className="w-3.5" />
            ...
            <button className="md:mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium">
