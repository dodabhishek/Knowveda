...
const AddCourse = () => {
  ...
  return (
    <div className='min-h-screen overflow-scroll flex flex-col items-start md:p-8 p-4 pt-8'>
      <form className='flex flex-col gap-4 max-w-md w-full text-gray-500' onSubmit={handleSubmit}>
        ...
        <div>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div className='flex justify-between items-center mb-2' key={lecture.lectureId}>
                      <span>
          ...
          <div className='flex justify-center items-center bg-blue-100 p-2 rounded-bl cursor-pointer' onClick={() => handleChapter('add')}>
            +Add Chapter
          </div>
          {showPopup && (
