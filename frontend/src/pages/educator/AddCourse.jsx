        ...
        <form action="" className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
          ...
          <div className='flex items-center justify-between flex-wrap'>
            ...
            <div className='flex md:flex-row flex-col items-center gap-3'>
              ...
              <label htmlFor="thumbnailImage" className='flex items-center gap-3'>
                ...
                <img className='max-h-10' src={image ? URL.createObjectURL(image) : 'none'} alt="" />
              </label>
            </div>
          </div>
          <div className='flex flex-col gap-1'>
          ...
          {/* Adding chapter Pending */}
            <div>
                ...
                <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
                  ...
                  {!chapter.collapsed && (
                    <div className='p-4'>
                        ...
                        <div className='inline-flex bg-gray-100 p-2 rounder cursor-pointer mt-2' >
                          + Add Lecture
                        </div>
                    </div>
                  )}
              ...
              <div className='flex justify-center items-center bg-blue-100 p-2 rounder-lb cursor-pointer' onClick={()=> handleChapter('add')}>
                +Add Chapter
              </div>
              {showPopup && (
